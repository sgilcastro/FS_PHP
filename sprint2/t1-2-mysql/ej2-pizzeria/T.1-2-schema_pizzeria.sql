...
INSERT INTO producto VALUES (1, 'Pizza margarita', 'Pizza con queso y tomate', '000001.jpg', '9', 'pizza',2);
...
INSERT INTO producto (nombre, descripcion, img, precio, tipo, id_categoria) VALUES ('Pizza de chocolate', 'Pizza con chocolate y almendras', 'pizza_chocolate.jpg', 11.50, 'pizza', 1);
...
INSERT INTO producto (nombre, descripcion, img, precio, tipo, id_categoria) VALUES ('Pizza de champiñones', 'Pizza con champiñones y queso', 'pizza_champinones.jpg', 12.00, 'pizza', 2);
INSERT INTO producto (nombre, descripcion, img, precio, tipo) VALUES ('Pepsi', 'Bebida gaseosa de cola', 'pepsi.jpg', 2.00, 'bebida');
INSERT INTO producto (nombre, descripcion, img, precio, tipo, id_categoria) VALUES ('Pizza de pepperoni', 'Pizza con pepperoni, champiñones y queso', 'pizza_pepperoni_champinones.jpg', 14.00, 'pizza', 2);
...
CREATE TABLE pedido (
    ...
    fecha_hora_entrega DATETIME DEFAULT NOW(),
    FOREIGN KEY(id_cliente) REFERENCES cliente(id),
    FOREIGN KEY(id_tienda) REFERENCES tienda(id),
    FOREIGN KEY(id_empleado) REFERENCES empleado(id)
);

INSERT INTO pedido (id, fecha_hora, id_cliente, tipo, id_tienda, id_empleado, fecha_hora_entrega) VALUES (1, '2022/05/01 01:00', 1, 'local', 2, 3, '2022-12-12 13:10:00');
...
-- Llista quantes comandes ha repartit un determinat empleat/da.
SELECT COUNT(pd.id) 'Total pedidos x realizados por empleado 3'
FROM pedido pd INNER JOIN empleado em ON pd.id_empleado = em.id
WHERE em.id = 3;