...
SELECT dp.nombre, COUNT(*) 'num profesores' FROM departamento dp INNER JOIN profesor pr ON dp.id = pr.id_departamento GROUP BY pr.id_departamento ORDER BY COUNT(*) DESC;
